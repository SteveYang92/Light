...
Setup (once)::
    ...
    # optional v1.5 weights: ./scripts/setup/setup_indextts_official.sh --with-v15
...
Run::
    ...
    uv run python scripts/tts/indextts_dub.py output/<run> --engine indextts2_metal --lang zh --skip-mix --preview
