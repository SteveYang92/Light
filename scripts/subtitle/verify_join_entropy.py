...
Usage: uv run python scripts/subtitle/verify_join_entropy.py
"""
...
from light_cli.llm_client import client_from_config
...
def main() -> None:
    ...
    result = join_cues(
        cues, units, config.translate_config(), llm=client_from_config(config) if config.llm_api_key else None
    )
