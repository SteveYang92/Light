...
echo "Preview (v2): uv run python scripts/tts/indextts_dub.py output/<run> --lang zh --skip-mix --preview"
echo "Preview (v1.5): uv run python scripts/tts/indextts_dub.py output/<run> --engine indextts15 --lang zh --skip-mix --preview"
