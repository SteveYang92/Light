...
from light_llm.usage.tracker import format_token_usage, save_step_usage
...
def prepare_context(
    ...
    *,
    ...
    ``llm=None`` means context prep is unavailable — returns an empty
    result without touching the disk (the orchestration layer gates on
    its own enable flag before calling).
    """
