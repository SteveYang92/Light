...
import typer
from light_asr import find_model, find_whisper
from light_core import logger
from light_llm.usage.report import load_usage_from_dir
...
def run(
    ...
    style_config: str = typer.Option(
        "",
        "--style-config",
        help="YAML style overrides for bilingual subtitle boxes (see light_cli/style/config.py)",
    ),
