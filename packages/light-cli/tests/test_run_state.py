...
import pytest
from light_cli.config import AsrEngine, SubtitleConfig
from light_cli.run_state import RunStateManager, RunStatus
from light_cli.step_plan import build_step_plan, resolve_start_index, validate_artifacts
...
def test_hydrate_words_from_transcript(tmp_path: Path):
    from light_cli.orchestrator import Orchestrator
    from light_cli.state_hydrate import hydrate_state
...
def test_step_registry_unique_ids():
    from light_cli.step_registry import build_step_definitions
...
def test_step_registry_hydrate_before_segment():
    from light_cli.step_registry import StepId, build_step_definitions
...
def test_hydrate_state_replays_plan_prefix(tmp_path: Path):
    from light_cli.orchestrator import PipelineState
    from light_cli.state_hydrate import hydrate_state
    from light_cli.step_plan import build_step_plan
    from light_cli.step_registry import StepId
